...
![Size](https://img.shields.io/github/repo-size/Nexus-FN/DabushOG?label=Size&style=for-the-badge)
![Visits](https://komarev.com/ghpvc/?username=Nexus-FN&style=for-the-badge)

### DabushOG has been discontinued.
### For a new and improved backend, use https://github.com/simplyzetax/Aphrodite

DabushOG is a fork and partial rewrite of the Fortnite Backend LawinServerV2. It is designed to enhance stability, offer production-ready features, and be blazingly fast. 🔥
...
[![Star History Chart](https://api.star-history.com/svg?repos=Nexus-FN/DabushOG&type=Date)](https://star-history.com/#Nexus-FN/DabushOG&Date)
